...
task_to_evaluation = {
    ...
    "SENTINEL2L2Asegmentation": evaluer_modele_sur_jeu_de_test_segmentation_sentinel,
    "SENTINEL1-2L2Asegmentation": evaluer_modele_sur_jeu_de_test_segmentation_sentinel,
    "SENTINEL2L2A-RVBsegmentation": evaluer_modele_sur_jeu_de_test_segmentation_sentinel,
    "SENTINEL1-2L2A-RVBsegmentation": evaluer_modele_sur_jeu_de_test_segmentation_sentinel,
